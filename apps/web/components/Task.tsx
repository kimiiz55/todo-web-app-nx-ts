...
export const Task: React.FC<IProps> = ({ task }) => {
  ...
  return (
    <li
      className="px-4 py-2 border border-gray-200 rounded-md shadow-sm cursor-pointer hover:shadow-md"
      onClick={() => dispatch({ type: FORM_TYPE.OPEN_UPDATE, payload: {_id: task._id} })}
    >
